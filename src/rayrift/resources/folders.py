...
class FoldersResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> FoldersResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/rayrift/python-sdk#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> FoldersResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/rayrift/python-sdk#with_streaming_response
        """
    ...
    def delete_folder(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._delete(
            path_template("/v1/folders/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def list_documents(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._get(
            path_template("/v1/folders/{id}/documents", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class FoldersResourceWithRawResponse:
    def __init__(self, folders: FoldersResource) -> None:
        ...
        self.retrieve_folder = to_raw_response_wrapper(
            folders.retrieve_folder,
        )
...
class AsyncFoldersResourceWithRawResponse:
    def __init__(self, folders: AsyncFoldersResource) -> None:
        ...
        self.retrieve_folder = async_to_raw_response_wrapper(
            folders.retrieve_folder,
        )
...
class FoldersResourceWithStreamingResponse:
    def __init__(self, folders: FoldersResource) -> None:
        ...
        self.retrieve_folder = to_streamed_response_wrapper(
            folders.retrieve_folder,
        )
...
class AsyncFoldersResourceWithStreamingResponse:
    def __init__(self, folders: AsyncFoldersResource) -> None:
        ...
        self.retrieve_folder = async_to_streamed_response_wrapper(
            folders.retrieve_folder,
        )
